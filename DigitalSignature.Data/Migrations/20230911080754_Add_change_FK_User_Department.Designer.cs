...
namespace DigitalSignature.Data.Migrations
{
    ...
    [Migration("20230911080754_Add_change_FK_User_Department")]
    partial class Add_change_FK_User_Department
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalSignature.Data.Entities.DocumentHistory", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DigitalSignature.Data.Entities.Form", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(450)
            ...
            modelBuilder.Entity("DigitalSignature.Data.Entities.Signature", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(450)
            ...
            modelBuilder.Entity("DigitalSignature.Data.Entities.DocumentHistory", b =>
                {
                    b.HasOne("DigitalSignature.Data.Entities.Document", "Document")
                        .WithMany("DocumentHistories")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigitalSignature.Data.Entities.Signature", "Signature")
                        .WithMany("DocumentHistories")
                        .HasForeignKey("SignatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigitalSignature.Data.Entities.AppUser", "User")
                        .WithMany("DocumentHistories")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DigitalSignature.Data.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
